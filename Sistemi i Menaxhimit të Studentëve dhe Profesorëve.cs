...
class Program
{
    ...
    static void RegjistroStudent()
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("Ju lutem konfirmoni moshen. Duhet të jetë një numër ndërmjet 18 dhe 30.");
        }
    ...
    static void RegjistroProfesor()
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("Ju lutem konfirmoni moshen. Duhet të jetë një numër ndërmjet 20 dhe 70.");
        }
        ...
        while (true)
        {
            Console.Write("Ora (vetëm numra): ");
            if (int.TryParse(Console.ReadLine(), out ora))
            {
                break;
            }
            Console.WriteLine("Ju lutem konfirmoni orën si numër.");
        }
    ...
    {
        persona.Add(new Professor { Emri = "Ilir Berisha", Mosha = 45, IdProfesori = 1, Lenda = "Struktura Diskrete", Dita = "E Mërkurë", Ora = 16 });
        persona.Add(new Professor { Emri = "Rrezart Prebreza", Mosha = 38, IdProfesori = 2, Lenda = "Algoritme dhe Struktura të të Dhënave", Dita = "E Enjte", Ora = 9 });
        persona.Add(new Professor { Emri = "Qendrim Hykaj", Mosha = 40, IdProfesori = 3, Lenda = "Hyrje në Telekomunikacion dhe Rrjeta Kompjuterike", Dita = "E Shtunë", Ora = 14 });
        persona.Add(new Professor { Emri = "Arianit Krypa", Mosha = 50, IdProfesori = 4, Lenda = "Sistemet Operative", Dita = "Self Paced", Ora = 0 });
        persona.Add(new Professor { Emri = "Besart Prebreza", Mosha = 34, IdProfesori = 5, Lenda = "Programim i Orientuar në Objekte", Dita = "Self Paced", Ora = 0 });
        persona.Add(new Professor { Emri = "Artan Aliu", Mosha = 29, IdProfesori = 6, Lenda = "Gjuhë Angleze Pre Intermediate", Dita = "Self Paced", Ora = 0 });
